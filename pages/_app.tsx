...
const WrapperApp = ({ children }: { children: any }) => {
  ...
  return (
    <div className={`relative ${store.ddIsDarkMode ? "darkPalette" : ""}`}>
      ...
      <Script
        type="module"
        src="https://sources-dynamic-devs-icons-cghyb9wjd-dynamic-icons.vercel.app/build/dynamic-devs-icons.esm.js"
      />
      <Script
        noModule={true}
        src="https://sources-dynamic-devs-icons-cghyb9wjd-dynamic-icons.vercel.app/build/dynamic-devs-icons.js"
      />
